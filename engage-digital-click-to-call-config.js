...
var engageDigitalClickToCallConfig = {
    ...
    /** Id of the Screenshare Button. Make sure the same id is used in your html Screen Share button.*/
    screenShareBtnId: 'engage-digital-click-to-share-btn',

    /** The text to be displayed for screenshare button once the call is establihsed */
    screenShareText: 'Screen Share',

    /** The text to be displayed on screensahre button after screen is being shared. So that user will get the context and can stop the screen share.*/
